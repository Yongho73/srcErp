...
var cf_InitParamMhshrm001 = function() {
    ...
    gf_ComboCode('divComboTaxofcCode', 'ComboTaxofcCode', 'ComboTaxofcCode', 'add', 'C204', '' , 'width:165%', '', '', '');	//세무서 코드
...
var fn_DhxDataProcessorMhshrm001 = function() {
    // 그리드입력 데이터프로세스 정의
	if(dhxDataProcessorMhshrm001){	
		dhxDataProcessorMhshrm001.detachEvent("onAfterUpdate");
		dhxDataProcessorMhshrm001 = null;
	}
