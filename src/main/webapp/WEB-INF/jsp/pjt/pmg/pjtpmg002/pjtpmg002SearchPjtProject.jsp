...
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/xerp/pjt/pmg/pjtpmg002/pjtpmg002SearchPjtProject.js"></script>
	...
	<div class="project_tab2_div mt10" style="margin-bottom:-1px;">
		<ul class="project_tab2">
			<a href="#"><li class="active">기본사항</li></a>
		</ul>
	</div>
	<div id="saveForm">
			...
			<table>
				...
				<tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="compNm" id="compNm" style="display:inline-block;float:left;" readonly required>
							<button class="btn_common03" id="btnBcncSearch" type="button" style="display:inline-block;float:left;">
