...
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/xerp/mhs/hrm/mhshrm015/mhshrm015SearchMhsOfcpsCode.js"></script>
    ...
    <!-- search_box -->
    <div class="search_box" id="searchFormMhsOfcpsCode">
        <table>
            <tr>
               <td>
                    <div class="btn">
    ...
    <div class="tabl_box">
        ...
        <div class="tdl-1">
            <div class="list_type01">
                <div class="list_top">
                    <h4 class="title03 fl">
                        <taglibs:transText progrmId="default" key="titMhsOfcpsCode" />&nbsp;<taglibs:transText progrmId="default" key="titList" />
                    </h4>
                    <span class="view ">
        ...
        <div class="tdl-2" id="saveForm">
            <div class="list_top02">
                <h4 class="title03" id="h4_pr_title">
                    <taglibs:transText progrmId="default" key="titMhsOfcpsCode" />&nbsp;<taglibs:transText progrmId="default" key="titRegist" />
                </h4>
            </div>
            <div class="detail_type01">
                <form id="saveFormMhsOfcpsCode">
                <table>
                    <caption><taglibs:transText progrmId="default" key="titMhsOfcpsCode" /></caption>
                    <colgroup>
                        <col width="150">
                        <col width="">
                    </colgroup>
                    <tr>
                        <th><taglibs:transText progrmId="default" key="titOfcpsCode" /></th>
                        <td><input required type="text" name="ofcpsCode" id="ofcpsCode" maxlength="20" style="width: 50%"/></td>
                    </tr>
                    <tr>
                        <th><taglibs:transText progrmId="default" key="titOfcpsNm" /></th>
                        <td><input required type="text" name="ofcpsNm" id="ofcpsNm" maxlength="50" style="width: 50%"/></td>
                    </tr>
                    <tr>
