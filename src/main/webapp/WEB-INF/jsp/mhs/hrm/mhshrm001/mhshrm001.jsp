                        ...
                        <form id="saveFormMhshrm001">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input required="true" type="text" name="bplcCode" id="bplcCodeSaveFormMhshrm001" maxlength="4" class="w70p"/></td>
                                    <th class="essential_icon">법인등록번호<!-- <taglibs:transText progrmId="default" key="titJurirno"/> --></th>
                                    <td colspan="3" ><input required="true" type="text" name="jurirno" id="jurirnoSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    <th class="essential_icon">사업장명<!-- <taglibs:transText progrmId="default" key="titBplcKorNm"/> --></th>
                                    <td><input required="true" type="text" name="bplcKorNm" id="bplcKorNmSaveFormMhshrm001" maxlength="30" class="w70p"/></td>
                                    <th>사업장 영문명<!-- <taglibs:transText progrmId="default" key="titBplcEngNm"/> --></th>
                                    <td><input type="text" name="bplcEngNm" id="bplcEngNmSaveFormMhshrm001" maxlength="30" class="w70p"/></td>
                                    <th class="essential_icon">사업자등록번호<!-- <taglibs:transText progrmId="default" key="titBizrno"/> --></th>
                                    <td><input required="true" type="text" name="bizrno" id="bizrnoSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    <th class="essential_icon">대표자명<!-- <taglibs:transText progrmId="default" key="titReprsntNm"/> --></th>
                                    <td><input required="true" type="text" name="reprsntNm" id="reprsntNmSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                    <th class="essential_icon">업태 <!-- <taglibs:transText progrmId="default" key="titBizcnd"/> --></th>
                                    <td><input required="true" type="text" name="bizcnd" id="bizcndSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                    <th class="essential_icon">종목<!-- <taglibs:transText progrmId="default" key="titInduty"/> --></th>
                                    <td><input required="true" type="text" name="induty" id="indutySaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        ...
                                        &nbsp;<input required="true" type="text" name="adres" id="adresSaveFormMhshrm001" maxlength="100" style="width: 39%"/>
                                        <input type="text" required="true" name="detailAdres" id="detailAdresSaveFormMhshrm001" maxlength="100" style="width: 54.1%"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="essential_icon">전화 번호<!-- <taglibs:transText progrmId="default" key="titTelno"/> --></th>
                                    <td><input required="true" type="text" name="telno" id="telnoSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                    <th>팩스 번호<!-- <taglibs:transText progrmId="default" key="titFaxNo"/> --></th>
                                    <td><input type="text" name="faxNo" id="faxNoSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                    <th>법정동코드<!-- <taglibs:transText progrmId="default" key="titDongCode"/> --></th>
                                    <td><input type="text" name="dongCode" id="dongCodeSaveFormMhshrm001" maxlength="10" class="w70p"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" name="capitalAmt" id="capitalAmtSaveFormMhshrm001" maxlength="22" class="w70p" class="ar"/></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input type="text" name="lcltytaxCmptinst" id="lcltytaxCmptinstSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    <th>홈택스 Id<!-- <taglibs:transText progrmId="default" key="titHtaxId"/> --></th>
                                    <td><input type="text" name="htaxId" id="htaxIdSaveFormMhshrm001" maxlength="10" class="w70p"/></td>
                                    <th>홈텍스 PW<!-- <taglibs:transText progrmId="default" key="titHtaxPassword"/> --></th>
                                    <td><input type="text" name="htaxPassword" id="htaxPasswordSaveFormMhshrm001" maxlength="300" class="w70p"/></td>
                                    <th>홈텍스 이메일<!-- <taglibs:transText progrmId="default" key="titHtaxEmail"/> --></th>
                                    <td><input type="text" name="htaxEmail" id="htaxEmailSaveFormMhshrm001" maxlength="60" class="w70p"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3"><input type="text" name="htaxAcnutNo" id="htaxAcnutNoSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    <th>홈택스 담당자<!-- <taglibs:transText progrmId="default" key="titHtaxCharger"/> --></th>
                                    <td><input type="hidden" name="htaxCharger" id="htaxChargerSaveFormMhshrm001" readonly maxlength="10" class="w70p"/>
                                        <input type="text" name="htaxChargerNm" id="htaxChargerSaveFormMhshrm001" readonly maxlength="10" class="w70p"/>
                                    ...
                                    <td colspan="3"><input type="text" name="htaxMbtlnum" id="htaxMbtlnumSaveFormMhshrm001" maxlength="20" class="w70p"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="smrizePayAt" id="smrizePayAtSaveFormMhshrm001" value="1">
                                                <i class="input-helper"></i>
                                            </label>
                                        </div>
                                    </td>
                                    <th>총괄 납부 번호<!-- <taglibs:transText progrmId="default" key="titSmrizePayNo"/> --></th>
                                    <td><input type="text" name="smrizePayNo" id="smrizePayNoSaveFormMhshrm001" maxlength="10" class="w70p"/></td>
                                    <th>사업자단위 과세여부<!-- <taglibs:transText progrmId="default" key="titBsnmUnitTaxtAt"/> --></th>
                                    <td>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="bsnmUnitTaxtAt" id="bsnmUnitTaxtAtSaveFormMhshrm001" value="1">
                                                <i class="input-helper"></i>
                                            </label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"><input type="text" name="bplcArea" id="bplcAreaSaveFormMhshrm001" maxlength="5" class="ar"/>
                                    ㎡ ※ 지방세 재산분 계산에 사용됨 
                                    </td>
                                </tr>
                                <tr>
