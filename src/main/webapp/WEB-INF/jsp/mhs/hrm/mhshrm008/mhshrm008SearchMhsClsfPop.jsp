...
function cf_SetComponentsPopupMenu(){
	...
	dhxGridTreeMenuInfo[0] = gf_MakeDhxGridHeader('직급코드', '150', 'center', 'str', 'ro', false, 'clsfCode', '');	
	dhxGridTreeMenuInfo[1] = gf_MakeDhxGridHeader('직급명',   '250','left','na', 'ro', false, 'clsfNm', '');
