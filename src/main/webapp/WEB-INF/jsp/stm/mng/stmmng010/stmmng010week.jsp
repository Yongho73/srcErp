...
<body>
    ...
    <script src="${pageContext.request.contextPath}/js/xerp/stm/mng/stmmng010/stmmng010week.js"></script>
            ...
            <div class="consearch_input">
                <form id="searchFormStmmng010">
                    ...
                    <ul class="consearchinput_list">
                        <!-- <li><span class="span">기준일자</span><input type="text" name="baseDe" id="baseDeSearchFormStmmng010" class="input_calen" size="10" maxlength="10"></li> -->
                        <li><span class="span"><label for="docmT">시스템구분</span><div id="divComboSysSeSearchFormStmmng010Week" style="display:inline-block"></div></li>
                    </ul>
                </form>
            </div>
        ...
        <div class="flex">
            <div class="item" style="width:calc(100% - 1px);">
                ...
                <!--      <div class="right">
                 ...
                 <div class="mt5 outer_line_grid" id="dataListStmmng010Week" style="height:calc(100vh - 150px); width:100%; position:relative;">
                </div>
            </div>
        </div>
