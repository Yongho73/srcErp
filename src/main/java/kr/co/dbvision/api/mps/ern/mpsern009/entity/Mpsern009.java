package kr.co.dbvision.api.mps.ern.mpsern009.entity;
...
public class Mpsern009 extends CommonVO {
    ...
    public Mpsern009(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mpsern009(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
