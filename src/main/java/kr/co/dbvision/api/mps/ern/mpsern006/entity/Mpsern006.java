package kr.co.dbvision.api.mps.ern.mpsern006.entity;
...
public class Mpsern006 extends CommonVO {
    ...
    public Mpsern006(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mpsern006(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
