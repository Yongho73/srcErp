package kr.co.dbvision.api.mps.bsc.mpsbsc017.entity;
...
public class Mpsbsc017 extends CommonVO {
    ...
    public Mpsbsc017(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mpsbsc017(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
