package kr.co.dbvision.api.mps.ins.mpsins006.entity;
...
public class Mpsins006 extends CommonVO {
    ...
    public Mpsins006(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mpsins006(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
