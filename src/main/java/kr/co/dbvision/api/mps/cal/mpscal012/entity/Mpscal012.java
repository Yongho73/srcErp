package kr.co.dbvision.api.mps.cal.mpscal012.entity;
...
public class Mpscal012 extends CommonVO {
    ...
    public Mpscal012(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mpscal012(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
