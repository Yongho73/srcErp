package kr.co.dbvision.api.pjt.pmg.pjtpmg002.entity;
...
public class Pjtpmg002 extends CommonVO {
    ...
    public Pjtpmg002(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.chargerSn = StringExpression.nullConvert(egovMap.get("chargerSn"));
            this.chargerDept = StringExpression.nullConvert(egovMap.get("chargerDept"));
            this.chargerClsf = StringExpression.nullConvert(egovMap.get("chargerClsf"));
            ...
            this.divideCode = StringExpression.nullConvert(egovMap.get("divideCode"));
        }
    }
