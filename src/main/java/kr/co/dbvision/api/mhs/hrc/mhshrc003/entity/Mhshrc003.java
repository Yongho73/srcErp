package kr.co.dbvision.api.mhs.hrc.mhshrc003.entity;
...
public class Mhshrc003 extends CommonVO {
    ...
    public Mhshrc003(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mhshrc003(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
