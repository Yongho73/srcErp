package kr.co.dbvision.api.mhs.edu.mhsedu001.entity;
...
public class Mhsedu001 extends CommonVO {
    ...
    public Mhsedu001(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mhsedu001(EgovMapForNull egovMap, String dhxGridrowIds ,String gubun) {
        super(egovMap); // && gubun == "1" ,String gubun
