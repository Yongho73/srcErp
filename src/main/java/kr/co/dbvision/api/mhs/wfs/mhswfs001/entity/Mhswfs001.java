package kr.co.dbvision.api.mhs.wfs.mhswfs001.entity;
...
public class Mhswfs001 extends CommonVO {
    ...
    public Mhswfs001(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mhswfs001(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
