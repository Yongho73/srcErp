package kr.co.dbvision.api.mhs.hrb.mhshrb011.entity;
...
public class Mhshrb011 extends CommonVO {
    ...
    public Mhshrb011(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mhshrb011(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
