package kr.co.dbvision.api.mhs.edu.mhsedu004.entity;
...
public class Mhsedu004 extends CommonVO {
    ...
    public Mhsedu004(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Mhsedu004(EgovMapForNull egovMap, String dhxGridrowIds,String gubun) {
        super(egovMap);
