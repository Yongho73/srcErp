package kr.co.dbvision.api.ets.box.etsbox001.entity;
...
public class Etsbox001 extends CommonVO {
    ...
    public Etsbox001(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Etsbox001(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
