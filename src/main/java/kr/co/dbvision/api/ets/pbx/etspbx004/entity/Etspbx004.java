package kr.co.dbvision.api.ets.pbx.etspbx004.entity;
...
public class Etspbx004 extends CommonVO {
    ...
    /* 기안자 부서명 */
    private String drafterDeptCodeNm;
    /* 결재 유형 코드 */
    private String sanctnTyCode;
    /* 결재 유형 명 */
    private String sanctnTyCodeNm;
    /* 비공개 사유 코드 */
    ...
    public Etspbx004(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.drafterEmpnm = StringExpression.nullConvert(egovMap.get("drafterEmpnm"));
            ...
            this.drafterDeptCodeNm = StringExpression.nullConvert(egovMap.get("drafterDeptCodeNm"));
            this.sanctnTyCode = StringExpression.nullConvert(egovMap.get("sanctnTyCode"));
            this.sanctnTyCodeNm = StringExpression.nullConvert(egovMap.get("sanctnTyCodeNm"));
    ...
    public Etspbx004(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.drafterEmpnm = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_drafterEmpnm")));
            ...
            this.drafterDeptCodeNm = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_drafterDeptCodeNm")));
            this.sanctnTyCode = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_sanctnTyCode")));
            this.sanctnTyCodeNm = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_sanctnTyCodeNm")));
    ...
    public String getDrafterEmpnm() {
        return drafterEmpnm;
    }
    public void setDrafterEmpnm(String drafterEmpnm) {
        this.drafterEmpnm = drafterEmpnm;
    }
    ...
    public String getDrafterDeptCodeNm() {
        return drafterDeptCodeNm;
    }
    public void setDrafterDeptCodeNm(String drafterDeptCodeNm) {
        this.drafterDeptCodeNm = drafterDeptCodeNm;
    }
    ...
    public String getSanctnTyCodeNm() {
        return sanctnTyCodeNm;
    }
    public void setSanctnTyCodeNm(String sanctnTyCodeNm) {
        this.sanctnTyCodeNm = sanctnTyCodeNm;
    }
