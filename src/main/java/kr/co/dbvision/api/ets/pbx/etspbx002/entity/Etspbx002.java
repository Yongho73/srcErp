package kr.co.dbvision.api.ets.pbx.etspbx002.entity;
...
public class Etspbx002 extends CommonVO {
    ...
    public Etspbx002(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.docSttusCodeNm = StringExpression.nullConvert(egovMap.get("docSttusCodeNm"));
    ...
    public Etspbx002(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.docSttusCodeNm = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_docSttusCodeNm")));
    ...
    public String getDocSttusCodeNm() {
        return docSttusCodeNm;
    }
    public void setDocSttusCodeNm(String docSttusCodeNm) {
        this.docSttusCodeNm = docSttusCodeNm;
    }
