package kr.co.dbvision.api.ets.pbx.etspbx001.entity;
...
public class Etspbx001 extends CommonVO {
    ...
    public Etspbx001(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Etspbx001(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
