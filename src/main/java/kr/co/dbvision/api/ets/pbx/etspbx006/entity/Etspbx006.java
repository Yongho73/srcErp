package kr.co.dbvision.api.ets.pbx.etspbx006.entity;
...
public class Etspbx006 extends CommonVO {
    ...
    public Etspbx006(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Etspbx006(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
