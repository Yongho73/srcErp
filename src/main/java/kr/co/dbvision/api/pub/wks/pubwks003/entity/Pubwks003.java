package kr.co.dbvision.api.pub.wks.pubwks003.entity;
...
public class Pubwks003 extends CommonVO {
    ...
    public Pubwks003(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Pubwks003(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
