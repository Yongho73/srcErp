...
public class Pubwks016View {

    @RequestMapping(value="view")
    public ModelAndView main(@RequestParam Map<String, Object> paramMap) {
        return new ModelAndView("pub/wks/pubwks016/pubwks016", paramMap);
    }
    ...
    public ModelAndView infoView(@RequestParam Map<String, Object> paramMap) {
        return new ModelAndView("pub/wks/pubwks016/pubwks016DtlRequstPopup", paramMap);
    }
}
