package kr.co.dbvision.api.pub.wks.pubwks004.entity;
...
public class Pubwks004 extends CommonVO {
    ...
    public Pubwks004(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
            ...
            this.deptNo = StringExpression.nullConvert(egovMap.get(StringExpression.toCamelCase(dhxGridrowIds+"_deptNo")));
