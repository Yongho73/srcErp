package kr.co.dbvision.api.pub.wks.pubwks021.entity;
...
public class Pubwks021 extends CommonVO {
    ...
    public Pubwks021(EgovMapForNull egovMap) {
        super(egovMap);
        if(egovMap != null) {
    ...
    public Pubwks021(EgovMapForNull egovMap, String dhxGridrowIds) {
        super(egovMap);
        if(egovMap != null) {
